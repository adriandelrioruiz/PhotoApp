		...
		btnRegistrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (OK) {
					...
					if (registrado) {
						JOptionPane.showMessageDialog(RegisterView.this, "Usuario registrado correctamente.", "Registro",
						...
						JOptionPane.showMessageDialog(RegisterView.this, "No se ha podido llevar a cabo el registro.\n",
								"Registro", JOptionPane.ERROR_MESSAGE);
						RegisterView.this.setTitle("Login Gestor Eventos");
					}
				}
			}
		});
