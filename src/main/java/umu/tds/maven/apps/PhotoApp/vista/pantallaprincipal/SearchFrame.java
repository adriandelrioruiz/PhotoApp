	...
	public SearchFrame(String query) {
		...
		for (DomainObject d : busqueda) {
			...
			if (d instanceof User) {
				...
				LoggedFrame.fixSize(panelUser, BUSQUEDA_WIDTH, 30);
				...
				LoggedFrame.fixSize(foto, 50, 30);
				...
				LoggedFrame.fixSize(foto, 100, 30);
				panelUser.add(foto);
		...
		LoggedFrame.fixSize(scroll, BUSQUEDA_WIDTH, BUSQUEDA_HEIGHT);
